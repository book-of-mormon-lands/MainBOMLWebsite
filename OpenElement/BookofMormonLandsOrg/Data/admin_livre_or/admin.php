			...
			<html>
			<head>
				<title>Tableau de bord du livre d'or</title>
				<meta charset="utf-8">
				<style type="text/css">		
					#admin h1 {
			...
			<body id="admin">
				<h1>Tableau de bord du livre d'or</h1>
							...
							//$open = fopen("admin.php","c");
								...
								foreach($contenu as $ligne){
									...
									echo "<tr>";
										...
										echo "<td><a href=\"admin.php?supp=$i\">Supprimer</a></td>";
									echo "</tr>";
								}
							//fclose($open);
							?>	
				...
				<?php
					...
					echo "<p>Aucun commentaire posté à ce jour.</p>";
				}		
				?>
				</div>
			</body>
